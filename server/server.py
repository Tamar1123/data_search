...
def build_llm_messages(user_query, table_schema, summary, history, rows=None, headers=None):
    ...
    system_content = (
        ...
        "• Small talk/off-topic → warm reply + invite a dataset question, sql=null. (1-2 short sentences)\n"
        ...
        "• Range questions always need TWO queries - one for the minimum and another for the maximum. with {result_0} and {result_1}.\n"
